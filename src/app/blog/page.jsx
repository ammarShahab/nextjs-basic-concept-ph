...
export default async function BlogPage() {
  ...
  // another thing u should know Here there is a something u see if u open ur network tab u will see the request is auto fetching the blogs upon scroll. which will like 24?_rsc=...., 25?_rsc=.... Because next js load the data according to the viewport size and send the data in a chunk.
